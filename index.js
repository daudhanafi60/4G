...
async function starts() {
	...
	client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `SAYONARA... @${num.split('@')[0]}👋* \n_Hati-Hati Dijalan, KAGA USAH BALIK LAGI LU GK PENTING :V_`
				let buff = await getBuffer(ppimg)
				client.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["6281216795577@s.whatsapp.net"] // GANTI NOMOR LU
			const adminbotnumber = ["6281216795577@s.whatsapp.net"] // GANTI NOMOR LU
			const frendsowner = ["6281216795577@s.whatsapp.net"] // GAUSAH DIGANTI!!!
			...
			case 'owner':
               ...
               client.reply(from, `Waalaikumsalam ${pushname}:)`)
                ...
                case 'report':
                    ...
                    client.sendMessage('6281216795577@s.whatsapp.net', options, text, {quoted: mek})
